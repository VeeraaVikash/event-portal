...
CREATE TABLE IF NOT EXISTS `proposals` (
  ...
  `att_internal_students` int DEFAULT NULL,
  `att_external_students` int DEFAULT NULL,
  `att_internal_faculty` int DEFAULT NULL,
  `att_external_faculty` int DEFAULT NULL,
  `report_summary` text COLLATE utf8mb4_unicode_ci,
